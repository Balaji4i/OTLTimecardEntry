...
System.out.println("66666666666666");
    ...
    public static String invokeSundayCreatePro(Object p_ref_id,String autoCreatepkg) throws SQLException {
...
//            new oracle.jbo.domain.Number(ref_id.toString());
        ...
        dobProcArgs =
                new Object[][] {
                    { "IN", p_ref_id, OracleTypes.VARCHAR }, //0                   
                    { "OUT", p_response, OracleTypes.VARCHAR } //1
                    } ;
        ...
        try {
            ...
            ADFContext.getCurrent().getSessionScope().put("p_flag",
                                                          flag);
